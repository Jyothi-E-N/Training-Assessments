# Q3. Print the calendar of a given month
# calendar(1,1948)
...
# code for finding the day of the given date
...
def date_to_week_day(date,month,year):
    ...
    #  returning directly the index for easier access 
    #  returns 0 for sunday, so no need for tab spaces to be printed
    return diff
...
def calendar(month, year):
    ...
    # need to find which day is first of the given month
